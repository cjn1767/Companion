...
public class PreparedStatement extends com.mysql.jdbc.StatementImpl implements java.sql.PreparedStatement {
    ...
    public static final class ParseInfo {
        ...
        public ParseInfo(String sql, MySQLConnection conn, DatabaseMetaData dbmd, String encoding, SingleByteCharsetConverter converter,
                    ...
                    switch (targetSqlType) {
                        ...
                        case Types.TIMESTAMP:
                            ...
                            if (parameterObj instanceof String) {
                                ...
                                java.text.DateFormat sdf = new SimpleDateFormat(getDateTimePattern((String) parameterObj, false), Locale.US);
                        ...
                        case Types.TIME:
                            ...
                            if (parameterObj instanceof String) {
                                java.text.DateFormat sdf = new SimpleDateFormat(getDateTimePattern((String) parameterObj, true), Locale.US);
