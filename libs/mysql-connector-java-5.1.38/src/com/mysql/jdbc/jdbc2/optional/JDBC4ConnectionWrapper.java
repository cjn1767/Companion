...
public class JDBC4ConnectionWrapper extends ConnectionWrapper {
    ...
    public SQLXML createSQLXML() throws SQLException {
        ...
        try {
            return ((Connection) this.mc).createSQLXML();
    ...
    public Array createArrayOf(String typeName, Object[] elements) throws SQLException {
        ...
        try {
            return ((Connection) this.mc).createArrayOf(typeName, elements);
        } catch (SQLException sqlException) {
            checkAndFireConnectionError(sqlException);
        }
    ...
    public Struct createStruct(String typeName, Object[] attributes) throws SQLException {
        ...
        try {
            return ((Connection) this.mc).createStruct(typeName, attributes);
        } catch (SQLException sqlException) {
            checkAndFireConnectionError(sqlException);
        }
    ...
    public Properties getClientInfo() throws SQLException {
        ...
        try {
            return ((Connection) this.mc).getClientInfo();
        } catch (SQLException sqlException) {
            checkAndFireConnectionError(sqlException);
        }
    ...
    public String getClientInfo(String name) throws SQLException {
        ...
        try {
            return ((Connection) this.mc).getClientInfo(name);
        } catch (SQLException sqlException) {
            checkAndFireConnectionError(sqlException);
        }
    ...
    public synchronized boolean isValid(int timeout) throws SQLException {
        try {
            return ((Connection) this.mc).isValid(timeout);
        } catch (SQLException sqlException) {
            checkAndFireConnectionError(sqlException);
        }
    ...
    public void setClientInfo(Properties properties) throws SQLClientInfoException {
        try {
            ...
            ((Connection) this.mc).setClientInfo(properties);
        } catch (SQLException sqlException) {
            try {
                checkAndFireConnectionError(sqlException);
    ...
    public void setClientInfo(String name, String value) throws SQLClientInfoException {
        try {
            ...
            ((Connection) this.mc).setClientInfo(name, value);
        } catch (SQLException sqlException) {
            try {
                checkAndFireConnectionError(sqlException);
            } catch (SQLException sqlEx2) {
    ...
    public Blob createBlob() throws SQLException {
        ...
        try {
            return ((Connection) this.mc).createBlob();
        } catch (SQLException sqlException) {
            checkAndFireConnectionError(sqlException);
        }
    ...
    public Clob createClob() throws SQLException {
        ...
        try {
            return ((Connection) this.mc).createClob();
        } catch (SQLException sqlException) {
            checkAndFireConnectionError(sqlException);
        }
    ...
    public NClob createNClob() throws SQLException {
        ...
        try {
            return ((Connection) this.mc).createNClob();
        } catch (SQLException sqlException) {
            checkAndFireConnectionError(sqlException);
        }
