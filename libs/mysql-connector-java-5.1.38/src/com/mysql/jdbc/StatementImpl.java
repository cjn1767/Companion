...
public class StatementImpl implements Statement {
    ...
    protected boolean createStreamingResultSet() {
        return ((this.resultSetType == ResultSet.TYPE_FORWARD_ONLY) && (this.resultSetConcurrency == ResultSet.CONCUR_READ_ONLY) && (this.fetchSize == Integer.MIN_VALUE));
    }
    ...
    protected long executeUpdateInternal(String sql, boolean isBatch, boolean returnGeneratedKeys) throws SQLException {
        synchronized (checkClosed().getConnectionMutex()) {
            ...
            try {
                ...
                rs = locallyScopedConn.execSQL(this, sql, -1, null, ResultSet.TYPE_FORWARD_ONLY, ResultSet.CONCUR_READ_ONLY, false,
    ...
    public ResultSet getResultSet() throws SQLException {
        synchronized (checkClosed().getConnectionMutex()) {
            return ((this.results != null) && this.results.reallyResult()) ? (ResultSet) this.results : null;
        }
    }
