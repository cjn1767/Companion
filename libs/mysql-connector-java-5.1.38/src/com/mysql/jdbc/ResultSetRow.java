...
public abstract class ResultSetRow {
    ...
    protected final Date getDateFast(int columnIndex, byte[] dateAsBytes, int offset, int length, MySQLConnection conn, ResultSetImpl rs,
        ...
        try {
            ...
            if (!onlyTimePresent && allZeroTimestamp) {
                ...
                switch (length) {
                    ...
                    default:
                        throw new SQLException("Bad format for Timestamp '" + StringUtils.toString(timestampAsBytes) + "' in column "
